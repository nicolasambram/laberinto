...
scene.onOverlapTile(SpriteKind.Player, assets.tile`miMosaico4`, function (sprite, location) {
    ...
    mySprite2.setPosition(80, 200)
    mySprite3.setPosition(80, 200)
})
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel6, function (sprite, location) {
    game.splash("Para terminar el nivel hay que llegar al portal")
})
...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    mySprite3.setPosition(99999999, 40590954)
    game.splash("Mono y ??? han sido teletransportados a el ultimo nivel")
})
controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    mySprite3.setImage(img`
        ...
        `)
    game.splash("Mono y ??? estan volviendo")
    mySprite2.setPosition(50, 50)
    mySprite3.setPosition(50, 50)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`miMosaico8`, function (sprite, location) {
    ...
    tiles.setCurrentTilemap(tilemap`nivel tutorial`)
    mySprite.setPosition(10, 90)
    mySprite2.setPosition(87658767, 786)
    mySprite3.setPosition(10, 90)
})
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel2, function (sprite, location) {
    game.splash("Cuidado con la lava")
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel4, function (sprite, location) {
    game.splash("...y las plataformas tambien")
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel1, function (sprite, location) {
    game.splash("Se salta con espacio")
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel5, function (sprite, location) {
    game.splash("En el nivel uno hay una mascota,para llevarla al ultimo nivel menu y para que vuelva arriba")
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.jewels.jewel3, function (sprite, location) {
    game.splash("Cada nivel es mas dificil...")
})
...
mySprite.ay = 500
mySprite.setPosition(10, 0)
mySprite2.setPosition(647483, 39428)
mySprite2.ay = 800
mySprite3.setPosition(647483, 39428)
mySprite3.ay = 800
game.splash("Bienvenido a Duck plataform® para moverse usar las flechas")
forever(function () {
